  ...
  <div class="h-full flex flex-col" :style="{ background: 'var(--sapBackgroundColor)' }">
    ...
    >
      ...
      <div class="flex items-center gap-2 mt-4">
        <template v-for="(step, idx) in pasos" :key="step.key">
          <div class="flex items-center gap-2">
            <div
              ...
              :style="pasoActivo === idx
                ? { background: 'var(--sapButton_Emphasized_Background)', borderColor: 'var(--sapButton_Emphasized_Background)', color: '#fff' }
                : idx < pasoActivo
            ...
            >
              <span v-if="idx < pasoActivo" class="sap-icon--accept text-xs" />
          ...
          <div v-if="idx < pasos.length - 1" class="flex-1 h-px mx-1" :style="{ background: 'var(--sapList_BorderColor)' }" />
        </template>
      </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto p-6">
      ...
      >
        <span class="sap-icon--message-warning text-xl shrink-0" :style="{ color: 'var(--sapCriticalColor)' }" />
        <div>
          <p class="font-semibold text-sm" :style="{ color: 'var(--sapTextColor)' }">Sin parada activa</p>
          <p class="text-sm" :style="{ color: 'var(--sapContent_LabelColor)' }">
      ...
      <div v-if="pasoActivo === 0" class="max-w-xl">
        <div
        ...
        >
          ...
          <div class="space-y-4">
            <div class="space-y-1.5">
              <label class="text-sm font-normal flex items-center gap-1" :style="{ color: 'var(--sapContent_LabelColor)' }">
              ...
              >
                <option value="">Seleccionar grupo activo...</option>
                <option v-for="g in gruposDisponibles" :key="g.id" :value="g">
                  {{ g.codigo }} — {{ g.nombre }}
                  <template v-if="g.lider"> · Líder: {{ g.lider.nombre }} {{ g.lider.apellido }}</template>
                </option>
              </select>
              <p v-if="loadingGrupos" class="text-xs" :style="{ color: 'var(--sapContent_LabelColor)' }">
                Cargando grupos...
              </p>
            </div>
            ...
            >
              <div class="flex items-center gap-2 mb-2">
                <span class="sap-icon--group text-sm" :style="{ color: 'var(--sapInformationTextColor)' }" />
      ...
      <div v-else-if="pasoActivo === 1" class="space-y-4">
        ...
        <template v-else-if="reservaActiva">
          ...
          >
            <div class="flex items-center gap-2 mb-1">
              <span class="sap-icon--approvals" :style="{ color: 'var(--sapInformationTextColor)' }" />
              <p class="text-sm font-semibold" :style="{ color: 'var(--sapTextColor)' }">
          ...
          >
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <p class="text-sm font-medium" :style="{ color: 'var(--sapTextColor)' }">
                  {{ item.catalogo?.nombre }}
                </p>
                <code class="text-xs font-mono" :style="{ color: 'var(--sapContent_LabelColor)' }">
                  {{ item.catalogo?.codigo_interno }}
                </code>
              </div>
              <span class="w-24 text-center text-sm" :style="{ color: 'var(--sapTextColor)' }">
                {{ item.cantidad }}
              </span>
              <span
          ...
          <div class="flex gap-3">
            ...
            <button
              ...
              :style="itemsSeleccionados.length > 0 && !despachando
                ...
                : { background: 'var(--sapNeutralBackground)', color: 'var(--sapContent_LabelColor)', border: '1px solid var(--sapList_BorderColor)' }"
            >
              <span v-if="despachando" class="flex items-center gap-2">
        ...
        <template v-else>
          ...
          >
            <div class="flex items-center gap-2">
              <span class="sap-icon--message-information" :style="{ color: 'var(--sapInformationTextColor)' }" />
              <p class="text-sm" :style="{ color: 'var(--sapInformationTextColor)' }">
          ...
          >
            <div class="space-y-3">
              <div class="space-y-1.5" v-show="!materialSeleccionado">
              ...
              <div v-if="!materialSeleccionado && resultadosReales.length > 0" class="space-y-2">
                  ...
                  >
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="flex items-center gap-2 mt-0.5">
                        <code class="font-mono text-xs" :style="{ color: 'var(--sapContent_LabelColor)' }">
                          {{ m.codigo_interno }}
                        </code>
                      </div>
                    </div>
              ...
              >
                ...
                <div class="flex items-center gap-2">
                  <span class="sap-icon--product" :style="{ color: 'var(--sapPositiveTextColor)' }" />
                ...
                <div class="grid grid-cols-2 gap-1 text-xs">
                  ...
                  <span class="font-semibold" :style="{ color: 'var(--sapPositiveTextColor)' }">{{ materialSeleccionado.cant_disponible }} unidades</span>
                ...
                <!-- Input cantidad -->
                <div class="space-y-1.5">
                  <label class="text-sm font-normal" :style="{ color: 'var(--sapContent_LabelColor)' }">Cantidad a entregar *:</label>
                  <input
                  ...
                  />
                  <p v-if="cantidadEntrega > materialSeleccionado.cant_disponible" class="text-xs" :style="{ color: 'var(--sapNegativeTextColor)' }">
                ...
                <!-- Observación -->
                <div class="space-y-1.5">
                  <label class="text-sm font-normal" :style="{ color: 'var(--sapContent_LabelColor)' }">Observación de entrega:</label>
                  <textarea
      ...
      <!-- ═══ PASO 3: Confirmación ═════════════════════════════════════════ -->
      <div v-else-if="pasoActivo === 2" class="max-w-xl">
        <div
        ...
        >
          ...
          <h2 class="text-xl font-bold" :style="{ color: 'var(--sapTextColor)' }">¡Entrega registrada!</h2>
          <p class="text-sm" :style="{ color: 'var(--sapContent_LabelColor)' }">

  ...
  >
    ...
    >
      ...
      <div class="flex-1 overflow-y-auto py-5 space-y-5">
        ...
        <div
          v-if="resultadosReales.length > 0"
          class="space-y-2"
        >
          ...
          <div class="rounded-md border border-border overflow-hidden">
            ...
            >
              ...
              <span
                :class="['shrink-0 inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium mt-0.5',
        ...
        <p
          v-if="resultadosReales.length > 1"
        ...
        <div
          ...
          class="rounded-lg border border-[var(--sapInformationBorderColor)] bg-[var(--sapInformationBackground)] p-4 space-y-3"
        >
        ...
        >
          <div class="space-y-1.5">
            ...
            <p
              v-else
              class="text-xs text-[var(--sapWarningColor)] flex items-center gap-1"
            >
